...
class ContactTest {
	...
	// -----------FINAL ENHANCMENT BASED ON FEEDBACK (testGroup)--------------------
	// Suggestion: Group Contacts
	@Test
	...
	// -----------FINAL ENHANCMENT BASED ON
	// FEEDBACK(testGroupNull)--------------------
	// Suggestion: Enhance Input Validation
	@Test
	void testContactGroupNull() {
		assertThrows(IllegalArgumentException.class, () -> contact.setGroup(null));
	}

	// -----------FINAL ENHANCMENT BASED ON
	// FEEDBACK(testGroupTooLong)--------------------
	// Suggestion: Enhance Input Validation
	@Test
	void testGroupTooLong() {
		String longGroup = "ThisGroupNameIsDefinitelyWayTooLongForTheContactClass";
		assertThrows(IllegalArgumentException.class, () -> contact.setGroup(longGroup));
	}
}
